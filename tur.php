...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light navbar-light py-5 py-lg-0">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            ...
            <a href="#package" target="_blank" class="btn btn-primary py-2 ml-auto d-none d-lg-block">Bugün Başla</a>
                        ...
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            ...
                            <div class="row mx-auto text-center">
                                <div class="col-lg-3 col-md-3 col-sm-4 mx-auto mx-md-auto mx-sm-auto mx-lg-auto">
                                    <a href="#package"
                                        class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mb-3">Bugün Başla</a>
                                </div>
                            </div>

                            <h3
                                class="display-car text-white text-uppercase mb-md-3 text-sm-center text-md-center text-lg-center ">
                                İngilizce röportajınıza hazırlanmanıza yardımcı oluyoruz.</h3>
                        </div>
                    </div>
                </div>
                <div class="carousel-item" style="min-height: 300px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            ...
                            <h3
                                class="display-car text-white text-uppercase mb-md-3 text-sm-center text-md-center text-lg-center">
                                Kendinden emin bir şekilde konuşarak etkili sonuçlar elde etmenize yardımcı oluyoruz.
                            </h3>
                ...
                <div class="carousel-item" style="min-height: 300px;">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            ...
                            <h3 class="display-car text-white text-uppercase mb-md-3">Sahip olduğunuz becerileri geliştirmenize yardımcı oluyoruz
                            başarıya ihtiyaç var.
                            </h3>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 col-sm-12" data-aos="fade-up" data-aos-delay="500" data-aos-duration="500"
                    ...
                    <div class="text-left mb-4">
                        <h5 class="text-primary text-uppercase mb-3 text-center fs-4" style="letter-spacing: 5px;">Hakkımızda
                        </h5>
                        <h3 class="text-white text-center">Interview in English'e Hoş Geldiniz!</h3>
                        <p class="text-center" style="font-weight: bold; font-size: 18px;">Ana dili İngilizce olmayan kişilerin iş görüşmelerinde başarılı olmalarına yardımcı olma konusunda uzmanız.</p>
                    </div>
    ...
    <div class="container-fluid py-3">
        <div class="container-fluid py-3 px-5">
            <div class="text-center">
                ...
                <h2 class="text-dark text-center"><i class="fa-solid fa-chart-simple"></i>&nbsp;GELECEĞİNİZE YATIRIM YAPIN
                </h2>
            </div>
            <div class="row align-items-center">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12 com-md-12">
                            <div class="main-div">
                                ...
                                <div class="benefits">
                                    <h4>Ömür Boyu İşinize Yarayacak Değerli Beceriler Öğrenin:</h4>
                                    <p style="line-height:35px; font-size:18px; font-weight: bold;">Özgüveninizi geliştirin, akıcılığınızı artırın ve daha iyi fırsatların kapısını açın.
                                    </p>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 mt-3" data-aos="fade-up" data-aos-delay="500"
                            ...
                            <div class="main-div">
                                ...
                                <div class="benefits">
                                    <h4>Esnek ve Uygun Maliyetli:</h4>
                                    <p style="line-height:35px; font-size:18px; font-weight: bold;">İstediğiniz her yerden, esnek ders programları ve uygun fiyatlarla öğrenin.
                                    </p>
                                </div>
                        ...
                        <div class="col-lg-12 col-md-12 mt-3" data-aos="fade-up" data-aos-delay="500"
                            ...
                            <div class="main-div">
                                ...
                                <div class="benefits">
                                    <h4>Gerçek Dünyada Sonuçlar:
                                    </h4>
                                    <p style="line-height:35px; font-size:18px; font-weight: bold;">Sektöre özgü deneyime sahip uzmanların kanıtlanmış başarı yöntemleriyle hedeflerinize ulaşın.
                                    </p>
                                </div>
                ...
                <div class="col-md-6 col-lg-6 text-center team mb-3 ">
                    <div class="team-item rounded overflow-hidden">
                        ...
                        <div class="bg-secondary p-4">
                            ...
                            <h5 class="m-0 text-primary">İşletme Koçu ve Mentor</h5>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 text-center team mb-3">
    ...
    <div id="reviews" class="container-fluid py-3">
        <div class="container-fluid py-3 px-5">
            <div class="text-center">
                ...
                <h2 CLASS="text-white mb-3">Öğrencilerimiz Ne Diyor?</h2>
            </div>
            <!-- Carousel wrapper -->
            <div class="row g-4">
    ...
    <div id="blog" class="container-fluid py-3 mb-0" data-aos="fade-up" data-aos-delay="500" data-aos-duration="500"
        ...
        <div class="container-fluid py-3 px-5">
            <div class="text-center ">
                <h5 class="text-primary text-uppercase mb-3" style="letter-spacing: 5px;">Blogumuz
                </h5>
                <h2 class="text-white">Blogumuzdan En Son Haberler</h2>
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="blog-item position-relative overflow-hidden rounded">
                        <img class="img-fluid" src="img/job-interview.jpg" alt="">
                        <a class="blog-overlay text-decoration-none" href="Why Hire a Job Interview Coach-tur.php">
                            <h5 class="text-white mb-3">Neden İş Görüşmesi Koçu Tutmalısınız?</h5>
                ...
                <div class="col-lg-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="blog-overlay text-decoration-none"
                            href="Tell Me About Yourself When the Interviewer-tur.php">
                            <h5 class="text-white mb-3">Görüşmeci "Bana Kendinden Bahset" Sorusuna Nasıl Cevap Verilir?
                            Özgeçmişiniz Önlerinde</h5>
                ...
                <div class="col-lg-4">
                    <div class="blog-item position-relative overflow-hidden rounded mb-2">
                        ...
                        <a class="blog-overlay text-decoration-none"
                            href="Effective Self-Presentation in Job Interviews-tur.php">
                            <h5 class="text-white mb-3">İş Görüşmelerinde Etkili Kişisel Sunum:</h5>
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form id="contactForm" method="POST">
                                <div class="form-group">
                                    <input type="text" class="form-control border-0 p-4" id="name" name="name" placeholder="Adınız
"
                                        required="required" />
                                </div>
                                <div class="form-group">
...
"
                                ...
                                <div class="form-group">
                                    <textarea cols="4" row="2" class="form-control border-0 p-4" id="message" name="message"
                                        placeholder="Mesajınızı Yazın" required="required"></textarea>
                                </div>

                                <div class="form-group" style="overflow: hidden;">
                                    <div class="g-recaptcha" data-sitekey="6LdQxhkrAAAAAOCu56DN4TA0F4pm6oG1M4IIe6dP" required="required"></div>
                                </div>
